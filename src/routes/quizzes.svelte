...
<template>
  ...
  <svg id="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px" role="img" class="grommetux-control-icon grommetux-control-icon-workshop grommetux-control-icon--huge grommetux-control-icon--responsive" aria-label="workshop">
